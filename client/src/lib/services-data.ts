...
export const SERVICES: ServiceInfo[] = [
  {
    ...
    overview: "Forestry mulching is a modern land clearing technique that uses a single piece of heavy equipment — a skid steer or compact track loader fitted with a high-speed mulching head — to grind standing brush, saplings, and undergrowth directly into the soil. Unlike traditional clearing methods that involve chainsaws, bulldozers, burn piles, and dump trucks, forestry mulching handles everything in one pass with zero debris to haul away. The mulching head shreds vegetation into small wood chips and fiber, creating a natural ground cover that suppresses weeds, retains soil moisture, and prevents erosion. This makes it the preferred clearing method for residential lot reclamation, new construction site prep, and rural acreage cleanup across the greater Charlotte area. Property owners in Mecklenburg, Union, and Cabarrus Counties choose forestry mulching because it's faster, cleaner, and typically 30–50% less expensive than traditional clearing. There's no need for burn permits, no risk of topsoil loss, and no waiting on hauling crews. The process also allows for selective clearing — our operators can work precisely around mature trees, structures, and landscaping features you want to preserve. From neglected subdivisions lots in Matthews to multi-acre tracts near Lake Norman, forestry mulching transforms overgrown land into usable property in a fraction of the time conventional methods require.",
    bestFor: [
  ...
  },
  {
    ...
    overview: "Trail cutting is the process of clearing defined pathways through wooded, brushy, or overgrown terrain to create usable access routes across your property. Whether you need a narrow 4-foot walking path to reach a back pond or a 12-foot wide lane for truck and equipment access, trail cutting transforms inaccessible land into connected, functional acreage. The process involves clearing vegetation, saplings, and ground-level brush along a designated route, then finishing the edges for a clean, maintained appearance. For property owners in Union County, Cabarrus County, and surrounding rural Charlotte communities, trail cutting is essential for unlocking the full potential of large parcels. Hunters use trail systems to connect food plots, tree stands, and camp areas without disturbing game patterns. Landowners use access lanes to reach ponds, creeks, fence lines, and timber stands that would otherwise require fighting through dense undergrowth. Real estate investors create trails to showcase back acreage that buyers would never see otherwise. We plan trail routes that work with the natural terrain — following ridgelines, avoiding wet areas, and connecting logical points on your property. Each trail is cut to your specified width with clean edges that give the finished product a professional, well-maintained look rather than a hacked-through appearance.",
    bestFor: [
  ...
  },
  {
    ...
    overview: "Hillside mulching is a specialized form of land clearing designed specifically for steep slopes, embankments, and uneven terrain where conventional equipment cannot safely operate. The Charlotte metro area — particularly Gaston County, Lincoln County, and communities along the Catawba River and Lake Norman shoreline — features rolling topography with countless hillsides that become choked with brush, vines, and invasive growth over time. Left unmanaged, these overgrown slopes create serious problems: trapped moisture accelerates erosion, dense brush becomes a fire hazard during dry seasons, and hidden gullies undermine the stability of the hillside itself. Traditional clearing methods like bulldozing are particularly destructive on slopes because they strip away the topsoil layer and root networks that hold the hill together, often causing the very erosion problems the owner was trying to prevent. Forestry mulching on hillsides takes a fundamentally different approach. Using tracked equipment rated for steep grades and mulching heads that grind vegetation in place, we clear brush and saplings while preserving the underlying soil structure and root systems. The mulch layer left behind acts as a natural erosion blanket — absorbing rainfall, slowing surface runoff, and allowing the ground to stabilize. We also selectively preserve anchor trees and deep-rooted vegetation that provide critical slope stability. The result is a cleared, visible hillside that is actually more resistant to erosion than it was before clearing. This approach is especially valuable for lakefront properties, roadside embankments, and residential lots with significant grade changes throughout the western Charlotte corridor.",
    bestFor: [
  ...
  },
  {
    ...
    overview: "Brush hogging — also called rotary mowing or bush hogging — is a heavy-duty mowing service designed for overgrown fields, pastures, and open land that has grown far beyond what a standard lawn mower or even a commercial zero-turn can handle. The equipment uses a tractor-mounted or skid steer-mounted rotary cutter with thick, swinging blades that can power through waist-high grass, dense weeds, goldenrod, blackberry canes, and light saplings up to 2–3 inches in diameter. It's the go-to solution for property owners across the rural Charlotte area who need large open areas brought back under control quickly and affordably. In communities like Waxhaw, Indian Trail, Mooresville, and the Lake Norman corridor, brush hogging is commonly used for pasture maintenance on horse farms, field reset on agricultural properties, vacant lot upkeep for real estate investors, and right-of-way clearing along driveways and private roads. Unlike forestry mulching — which targets dense woody vegetation and grinds it into the soil — brush hogging is specifically designed for grass-dominant growth on relatively flat, open terrain. It's a mowing solution, not a grinding solution, which makes it significantly faster and more cost-effective for the right application. Many property owners benefit from setting up recurring brush hogging schedules — monthly during the growing season, or quarterly for slower-growing areas — to keep fields from reverting to overgrown conditions. We offer flexible scheduling and reduced rates for maintenance contracts, making it easy to keep your Charlotte-area property looking sharp year-round without the hassle of doing it yourself.",
    bestFor: [
  ...
  },
  {
    ...
    overview: "Fence line clearing is a targeted land clearing service focused on removing vegetation that has encroached on property boundaries, existing fences, easements, and rights-of-way. In the Charlotte metro — especially in established neighborhoods across Mecklenburg County, south Charlotte, Matthews, and Mint Hill — property line vegetation is one of the most common sources of maintenance headaches and neighbor disputes. Over time, privet hedges, honeysuckle vines, wild grape, and general brush grow unchecked along fence lines until they consume the fence entirely, obscure survey markers, and create disputed boundaries between adjacent properties. Fence line clearing addresses all of these problems by cutting back vegetation to a specified width on each side of the property line, carefully working around existing fence structures to avoid damage, and removing vine growth that has woven through chain link, wood slat, or wire fencing. The service is also essential for fence installation prep — contractors typically require 4–6 feet of clear, accessible ground on each side of the planned fence line before they can begin work. Without proper clearing, fence installers either charge premium rates to deal with the vegetation themselves or simply refuse the job until the line is cleared. Beyond residential applications, fence line clearing is widely used for commercial property maintenance, HOA common area boundaries, utility easement access restoration, and farm fence maintenance across the rural Charlotte corridor. We clear fence lines of any length — from a 50-foot backyard boundary to miles of pasture fencing — and leave clean, professional edges that make the cleared boundary look intentional and well-maintained.",
    bestFor: [
  ...
  },
  {
    ...
    overview: "Invasive species removal is a specialized land management service that targets non-native plants aggressively overtaking properties throughout the Charlotte, NC metro area. The Piedmont region of North Carolina is home to some of the most aggressive invasive plant species in the southeastern United States, including kudzu, Chinese privet, Japanese honeysuckle, wisteria, English ivy, Bradford pear seedlings, and tree-of-heaven. These species share a common trait: they grow faster and more aggressively than native vegetation, eventually smothering everything around them. Kudzu can grow up to a foot per day in peak season, covering entire tree canopies and collapsing structures under its weight. Chinese privet forms impenetrable thickets that block light and choke out native understory plants. Honeysuckle and wisteria strangle trees by wrapping tightly around trunks and branches, cutting off nutrient flow and eventually killing mature hardwoods worth thousands of dollars. English ivy climbs to the tops of trees, adds massive wind load, and causes blowdowns during storms. Beyond the ecological damage, invasive growth creates real financial consequences for property owners. HOAs across Mecklenburg County, Fort Mill, and Concord actively issue violation notices for uncontrolled invasive vegetation. Properties with severe infestations appraise lower and sell slower. Insurance companies view overgrown properties as higher risk for storm damage claims. Our invasive growth removal service uses an integrated approach — mechanical clearing to remove the visible growth, followed by targeted cut-stump treatment to kill root systems and prevent regrowth. Simply cutting invasive species without treating the root system is a temporary fix at best, as most species will regenerate from root networks within weeks. We identify every invasive species present on your property, map the extent of the infestation, execute mechanical removal, apply appropriate treatments, and provide a follow-up management plan to keep the property clear long-term.",
    bestFor: [
